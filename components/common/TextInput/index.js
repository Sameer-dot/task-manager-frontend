...
const input = cva(
  "h-10 w-full rounded-[4px] border-[1px] border-medium-gray border-opacity-25 bg-transparent py-2 pl-4 text-[15px] font-medium leading-[19px] dark:text-white text-black dark:text-white outline-none duration-200 focus:border-purple",
  {
    variants: {
      error: {
